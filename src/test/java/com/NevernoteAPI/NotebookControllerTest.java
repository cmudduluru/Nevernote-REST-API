...
import com.NevernoteAPI.Notebook.Notebook;
import com.NevernoteAPI.Notebook.NotebookController;
import com.NevernoteAPI.Notebook.NotebookService;
...
public class NotebookControllerTest {
	...
	Notebook mockNotebook = new Notebook("Maths", "This is Maths Notebook");
	...
	public void createNotebookTest() throws Exception {
		Mockito.doNothing().when(notebookService).createNotebook(Mockito.any(Notebook.class));
